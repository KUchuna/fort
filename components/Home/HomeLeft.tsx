        ...
        <section className="flex flex-col gap-6 w-full lg:w-[70%]">
            ...
            <div className="flex flex-col md:flex-row gap-6 h-auto md:h-[40%]">
                ...
                className="flex flex-1 container relative group p-6 md:p-0">
                    ...
                    <Image src={circle} alt="" width={100} height={100} className="absolute hidden md:flex left-6 top-6 group-hover:-rotate-90 transition-all duration-200 w-[50px] 3xl:w-[100px]"/>
                </motion.div>
                <motion.div
                    whileHover={{
                        y: -6,
