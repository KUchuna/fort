        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar pr-1 space-y-2">
            ...
            {view === 'liked-songs' && (
                <div className="flex flex-col">
                    <div className="flex items-center gap-3 mb-4 p-2 bg-linear-to-r from-[#450af5] to-[#c4efd9]/10 rounded-md">
                        <div className="w-12 h-12 flex items-center justify-center bg-linear-to-br from-[#450af5] to-[#8e8e8e] text-white rounded-md shadow-lg">
